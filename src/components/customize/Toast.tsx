...
export default function Toast({ type, msg }: ToastObj) {
  ...
  return (
    <div className={`flex items-center gap-3 px-4 py-3 rounded-xl shadow-lg text-sm font-medium animate-fade-in-up glass-card !p-3 ${isSuccess ? "text-ocean" : "text-red-600"}`}>
      {isSuccess ? (
