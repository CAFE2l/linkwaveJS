...
const benefits = [
  {
    icon: ShieldCheck,
    text: "Autenticação segura com Supabase Auth",
  },
  {
    icon: Zap,
    text: "Acesso instantâneo ao seu painel",
  },
  {
    icon: Lock,
    text: "Seus links protegidos com RLS",
  },
];
        ...
        <section className="grid flex-1 items-center gap-10 pb-8 lg:grid-cols-[1fr_30rem]">
          <div className="hidden lg:block">
            ...
            <p className="mt-5 max-w-xl text-base leading-relaxed text-muted">
              Acesse seu painel para gerenciar seus links, acompanhar
              estatísticas e personalizar sua página.
            </p>
